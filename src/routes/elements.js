...
// DASHBOARD: STUDENT
// export const StudentListPage = Lodable(lazy(()=> import('../pages/dashboard/StudentListPage')));
...
export const SchoolCreatePage = Loadable(lazy(() => import('../pages/dashboard/SchoolCreatePage')));
export const SchoolEditPage = Loadable(lazy(() => import('../pages/dashboard/SchoolEditPage')));

// DASHBOARD: BECA
export const BecaListPage = Loadable(lazy(() => import('../pages/dashboard/BecaListPage')));
export const BecaDetailsPage = Loadable(lazy(() => import('../pages/dashboard/BecaDetailsPage')));
export const BecaCreatePage = Loadable(lazy(() => import('../pages/dashboard/BecaCreatePage')));
export const BecaEditPage = Loadable(lazy(() => import('../pages/dashboard/BecaEditPage')));

// DASHBOARD: MODALITY
export const ModalityListPage = Loadable(lazy(() => import('../pages/dashboard/ModalityListPage')));
export const ModalityDetailsPage = Loadable(lazy(() => import('../pages/dashboard/ModalityDetailsPage')));
export const ModalityCreatePage = Loadable(lazy(() => import('../pages/dashboard/ModalityCreatePage')));
export const ModalityEditPage = Loadable(lazy(() => import('../pages/dashboard/ModalityEditPage')));

// DASHBOARD: SHIFT
export const ShiftListPage = Loadable(lazy(() => import('../pages/dashboard/ShiftListPage')));
export const ShiftDetailsPage = Loadable(lazy(() => import('../pages/dashboard/ShiftDetailsPage')));
