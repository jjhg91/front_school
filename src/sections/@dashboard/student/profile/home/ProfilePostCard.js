  ...
  return (
    <Card>
      <CardHeader
        disableTypography
        avatar={
          <CustomAvatar src={student?.user?.photoUrl} alt={student?.user?.displayName} name={student?.user?.displayName} />
        }
        title={
      ...
      >
        <CustomAvatar src={student?.photoUrl} alt={student?.displayName} name={student?.displayName} />
