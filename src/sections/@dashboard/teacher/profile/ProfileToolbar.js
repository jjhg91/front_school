...
export default function ProfileToolbar({ teacher }) {
  ...
  const handlePreEnrollment = () => {
    navigate(PATH_DASHBOARD.preEnrollment.new);
  };
    ...
    <>
      ...
      >
        <Stack direction="row" spacing={1}>
          <Tooltip title="Asignar Asignatura">
            <IconButton onClick={handlePreEnrollment}>
              <Iconify icon="ic:twotone-create-new-folder" />
            </IconButton>
          </Tooltip>
          ...
          {/* <PDFDownloadLink
            document={<ProfilePDF teacher={teacher} />}
            fileName={teacher.teacherNumber}
