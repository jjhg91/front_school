...
} from '../../sections/@dashboard/school/details';
// redux
...
export default function SchoolDetailsPage() {
  ...
  const TABS = [
    {
      ...
      component: <AccountGeneral school={school}/>,
    },
    {
      value: 'billing',
      label: 'Billing',
  ...
  return (
    <>
      <Helmet>
        <title> School: View | Minimal UI</title>
      </Helmet>
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: 'Schools', href: PATH_DASHBOARD.school.root },
            { name: 'Detail' },
          ]}
        />
